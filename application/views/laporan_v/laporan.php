    ...
    <div class="container text-center py-3" style="width: 500px; margin-top: 50px;">
        <table class="table" style="width: 500px;">
            ...
            <!-- <tr>
                ...
                <td><input type="date" name="tgl_masuk" id="input-tanggal" value="0000-00-00" class="form-control"></td>
                <th class="text-dark" style="font-weight: bold;">-</th>
                <th><label for="tanggal_akhir">Tanggal Akhir</th>
                <th><input type="date" name="tgl_akhir" id="tanggal_akhir" class="form-control" value="0000-00-00"></th>
            </tr> -->
            <tr>
